...
void CheckBox::check(){
	::CheckDlgButton(window->window_handle,menu_id, BST_CHECKED);
	//komplett falsch:checkdlgbutton auf parent
}
void CheckBox::uncheck(){
	::CheckDlgButton(window->window_handle, menu_id, BST_UNCHECKED);

}
bool CheckBox::is_checked(){
	return ::IsDlgButtonChecked(window->window_handle, menu_id);
